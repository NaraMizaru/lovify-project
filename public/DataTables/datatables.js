 ...
 *   https://datatables.net/download/#dt/dt-2.1.3/cr-2.0.3/fh-4.0.1/r-3.0.2/sp-2.3.1
 *
 * Included libraries:
 *   DataTables 2.1.3, ColReorder 2.0.3, FixedHeader 4.0.1, Responsive 3.0.2, SearchPanes 2.3.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.1.3/cr-2.0.3/fh-4.0.1/r-3.0.2/sp-2.3.1",
